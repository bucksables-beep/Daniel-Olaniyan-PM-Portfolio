        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 items-start">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-8 text-gray-300 space-y-4 leading-relaxed">
              ...
              <p>My journey in product began with a curiosity for how technology could solve real-world financial challenges. I have wide range of expertise given my cross-industry experience in Fintech, SaaS, eCommerce, AI/ML, social media and marketplace applications. I am a firm believer in a data-informed approach, leveraging analytics to uncover user needs and drive product strategy.</p>
              <p>Beyond the roadmap, I'm passionate about mentorship and building a positive team culture. I believe that the best products are built by empowered, collaborative teams who are aligned on a common goal. When I'm not obsessing over user flows and feature backlogs, you can find me exploring and reading about the latest in machine learning, engagiing in sporting activities, volunteering or contributing to open-source projects.</p>
            </div>
