...
const Hero: React.FC = () => {
  return (
    <section className="min-h-[calc(100vh-80px)] grid grid-cols-1 lg:grid-cols-[1fr_auto] items-center gap-12 lg:gap-24 px-6 md:px-20 lg:pr-32 py-24 relative" id="hero">
      ...
      <div className="relative z-[2] max-w-[700px]">
        <div className="font-mono text-sm text-[#0DDFF2] tracking-[0.2em] uppercase flex items-center gap-4 mb-10 animate-[fadeUp_0.7s_0.2s_forwards] opacity-0">
          <div className="w-10 h-px bg-[#0DDFF2]"></div>
        ...
        <p className="mt-10 text-body-xl text-[#6E8099] font-light max-w-[550px] animate-[fadeUp_0.8s_0.5s_forwards] opacity-0">
        ...
        <div className="flex flex-wrap gap-6 items-center mt-12 animate-[fadeUp_0.8s_0.65s_forwards] opacity-0">
          <Link to="/work" className="font-mono text-sm tracking-[0.06em] px-10 py-5 bg-[#0DDFF2] text-[#070B12] rounded-[4px] no-underline transition-all duration-200 font-bold hover:bg-[#0bc8d9] uppercase">
            See My Work
          </Link>
          <Link to="/contact" className="font-mono text-sm tracking-[0.06em] px-10 py-5 bg-transparent text-[#6E8099] border border-white/10 rounded-[4px] no-underline transition-all duration-200 hover:border-[#0DDFF2]/30 hover:text-[#0DDFF2] uppercase">
            Get in Touch
          </Link>
        </div>
        <div className="flex flex-wrap gap-x-16 gap-y-8 mt-20 pt-12 border-t border-white/10 animate-[fadeUp_0.8s_0.8s_forwards] opacity-0">
          {STATS.map((stat) => (
            <div key={stat.label}>
              <div className="font-syne font-bold text-4xl text-[#DDE4EE] leading-none">
                {stat.value}<span className="text-[#0DDFF2]">{stat.suffix}</span>
              </div>
              <div className="font-mono text-xs text-[#3A4D62] tracking-[0.1em] uppercase mt-3">
                {stat.label}
              </div>
            </div>
          ))}
      ...
      <div className="relative z-[2] animate-[fadeIn_1s_0.5s_forwards] opacity-0 hidden lg:flex justify-end p-12">
        <div className="relative w-[320px] xl:w-[380px] aspect-[4/5] group">
          {/* Decorative elements */}
          ...
          <div className="absolute -top-6 -right-6 bg-[#0DDFF2] p-3 px-5 rounded-[4px] shadow-2xl rotate-3 hidden xl:block z-10">
