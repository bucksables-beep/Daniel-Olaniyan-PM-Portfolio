...
const Portfolio: React.FC = () => {
  return (
    <section className="py-32 px-6 md:px-20 bg-[#070B12] min-h-[calc(100vh-80px)]" id="work">
      <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row justify-between items-end mb-20 reveal">
        <div>
        ...
        <p className="max-w-[400px] text-xl text-[#6E8099] leading-[1.7] font-light mt-10 md:mt-0">
      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        {PROJECTS.map((project, idx) => (
          <div 
            key={project.id} 
            className={`bg-[#111827] border border-white/10 p-12 flex flex-col min-h-[400px] relative overflow-hidden transition-all duration-300 group hover:bg-[#162035] hover:-translate-y-2 reveal ${idx === 0 ? 'md:col-span-2 bg-[#0C1220]' : ''}`}
          >
